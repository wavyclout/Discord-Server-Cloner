...
# Please note that this is a self bot so you are gonna need to obtain your discord account token in order to use this code

from dotenv import load_dotenv

load_dotenv()

token = os.getenv("token") # Make a secret in replit called "token"
# If you are on vsc or any other code editor then replace "token" with your actual discord account token
